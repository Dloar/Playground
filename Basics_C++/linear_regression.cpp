...
//  BegCpp
//
//  Created by Ondrej Kral on 16/08/2019.
//  Copyright © 2019 Ondrej Kral. All rights reserved.
//
...
int main()
{
    inFile.open("/Users/ondrejkral/Documents/GitHub/Playground/Basics_C++/regressionData.txt");
    while (!inFile.eof()) {
        inFile>>x[i];
        inFile>>y[i];
