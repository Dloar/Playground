...
num_friends_by_id = [(user["id"], num_of_friends(user))
                    for user in users]

sorted(num_friends_by_id, key=lambda (user_id, num_friends):num_friends, reverse = True)

# Data scientist you may know - by friend of a friend
...
# For user zero
friend_of_friend_ids_bad(users[0])
...
interests = [
    ...
    (3, "statistics"), (3, "regression"), (3, "ptobability"),
